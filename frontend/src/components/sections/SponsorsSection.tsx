  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center items-center space-y-10 gap-x-5 md:space-x-10  gap-y-2 px-10 py-2 flex-wrap backdrop-blur  ">
       <a href="https://urban-vada-pav.ueniweb.com/" target="_blank" rel="noopener noreferrer">
        ...
        <img
          ...
          <a href="https://baskinrobbinsindia.com/" target="_blank" rel="noopener noreferrer">
        ...
        <img
          ...
          <a href="https://www.imsindia.com/center/kanpur/" target="_blank" rel="noopener noreferrer">
        ...
        <img
          ...
          <a href="https://www.feedingindia.org/" target="_blank" rel="noopener noreferrer">
