          ...
          >
            ...
            >
              ...
              >
                ...
                robot that can make a goal by pushing the ball into the
                opponent's goal post and defends own goal post. This event tests
                your stability control, handling, and your techniques in
                competing with your opponent. The simultaneous movement rules
                encourage clever strategies and counterstrategies as players try
                to second-guess their opponents.
                <h1 className="font-primary text-2xl md:text-5xl text-center mt-5 mb-5">
                  Guidelines: <br />
                </h1>
                ...
                <br />
                ● Each robot should not Exceed by maximum
                30cm*30cm*30cm(l*b*h*). <br />
                ● Team can use ball hit mechanism but not Griper mechanism to
                hold the ball. <br />
                ● Teams have to use same bot for all the rounds. <br />
                ● The robot can be wired/ wireless. In case of wired control,
                the wires should be slack all the time. <br />
                ...
                ● The machine must be powered electrically only. Use of IC
                engine is not allowed ● The machine must not be made from Lego
                parts, or any ready-made kit, if we find such a machine it will
                be disqualified. Use of ready-made chassis/ RC Car is not
                allowed. <br />
                ...
                disqualification. <br />
                ● The ball can be either dragged or pushed by the team’s bot.{" "}
                <br />
                ● Maximum 2 members per team will be allowed to remain close to
                the field for operating the robots. <br />
                ● In case of a jam up of robots for more than 30 seconds the
                robots will have to kick-off again at the order of the referee.{" "}
                <br />
                ● In case of any discrepancy the final decision rests in the
                hands of coordinators. <br />
