          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="text-slate-800">11:15-1:15 PM
</span>
              </div>
            </div>
            ...
            >
              ...
              ● After assessing the question, team members need to make the list
              of the components by their own along with the circuit diagram and
              present it to the jury members. After that they will be allowed to
              pick up the necessary components and implement the circuit and
              present the output to the jury members. <br />
              ...
              ● Time limit for the competition is 30 min. <br />● Circuit
              implemented on paper without taking hints: 20 points <br />
