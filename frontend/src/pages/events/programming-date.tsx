          ...
          >
            ...
            >
              ...
              >
                ...
                It is a multi round event, in the first round the participants
                of opposite gender are paired for the second round in which they
                would be solving a problem statement together.
                <h1 className="font-primary text-2xl md:text-5xl text-center mt-5 mb-5">
                  Guidelines:
                  <br />
                </h1>
                • There will be indivual registration for the participants.{" "}
                <br />
