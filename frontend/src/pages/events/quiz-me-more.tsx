      ...
      <>
          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="text-slate-800">11 AM-12 PM</span>
              </div>
            </div>
            ...
            >
              ...
              A two round quiz event which will test general & basic engineering
              knowledge of the participants and only 4 teams will get the chance
              to enter round 2. <br />
              <h1 className="font-primary text-2xl md:text-5xl text-center mt-5 mb-5">
                Guidelines: <br />
              </h1>
        ...
        >
          <div className="w-full max-w-xl h-97/100 bg-white shadow-lg relative rounded-lg">
            ...
            <EventRegistrationForm eventId="TSCCE02" />
          </div>
        </div>
      </>
    </Layout>
