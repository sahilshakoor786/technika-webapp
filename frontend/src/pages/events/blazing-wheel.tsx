          ...
          >
            ...
            >
              ...
              >
                ...
                Design a wired/wireless manually controlled robot which should
                be able to travel on uneven terrain both land, water, etc. The
                robot that traverses all the hurdles and completes the track in
                a minimum amount of time is declared as the winner.
                <h1 className="font-primary text-2xl md:text-5xl text-center mt-5 mb-5">
                  BOT SPECIFICATIONS :<br />
                </h1>
                ● The dimensions of the vehicle must be within 25 cm x 20cm x15
                cm (l x b x h). <br />
                ...
                engine is not allowed. <br />● The machine must not be made from
                Lego parts, or any ready-made kit, if we find such a machine it
                will be disqualified. Use of ready-made chassis/ RC Car is not
                allowed. <br />
                ...
                check <br />
                ● Teams must start their robots from the starting line only
                after a signal is given by the Referee. <br />
                ● The timer starts immediately after the signal is given. <br />
                ● Number of participants per team should not exceed 4. <br />
                ● Bot should always remain inside the track. If the bot leaves
                the track at any point of the time during the race or becomes
