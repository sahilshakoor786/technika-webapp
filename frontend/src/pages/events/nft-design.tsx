        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                height: 500,
                backgroundImage: `url("https://d2jf5yk8vvx0ti.cloudfront.net/images/nftdesign.jpeg")`,
              }}
            >
            ...
            >
              ...
              We are sure that all the money minded tech geeks out there must’ve
              atleast once (if not repeatedly) in these past few months played
              with the idea of buying/ curating or even synthesizing a
              non-fungible token. So here’s your chance to let your creativity
              run wild but under certain space and time constraints, ironical ?
              We know.
              <h1 className="font-primary text-2xl md:text-5xl text-center mt-5 mb-5">
                Guidelines: <br />
              </h1>
