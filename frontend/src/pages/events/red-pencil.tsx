      ...
      <>
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                height: 500,
                backgroundImage: `url("https://d2jf5yk8vvx0ti.cloudfront.net/images/redpencil.avif")`,
              }}
            >
              ...
              >
                ...
                <span className="text-slate-800">4:30 PM-5:30 PM</span>
              </div>
            </div>
            ...
            >
              ...
              How many more times are you gonna go to the PlayStore hat in hand
              begging for the solutions to your problems. It is high time to
              take matters into your own hands and design an android application
              for the problem statement that will be given to you.
              <h1 className="font-primary text-2xl md:text-5xl text-center mt-5 mb-5">
                Guidelines: <br />
              </h1>
              This event will be organized in two phases. First round:
              Participants will be given an idea. They have to implement that
              idea into an Android Application, based on their app, they will be
        ...
        >
          <div className="w-full max-w-xl h-97/100 bg-white shadow-lg relative rounded-lg">
            ...
            {/* <EventRegistrationForm eventId="TSCGC04" /> */}
          </div>
        </div>
      </>
    </Layout>
