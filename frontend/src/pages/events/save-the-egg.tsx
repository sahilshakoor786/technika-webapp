            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className="text-slate-800 ">Civil Dept</span>
                  <span className="font-primary font-bold text-slate-800 ">
                    Date
                  </span>
                  ...
                  <span className="text-slate-800">4 PM-5 PM</span>
                </div>
              </div>
              ...
              >
                ...
                from. In this contestants have to create a platform on which
                eggs will be dropped from a certain heights and they should make
                sure that eggs won't break.
                <h1 className="font-primary text-2xl md:text-5xl text-center mt-5 mb-5">
                  Guidelines: <br />
                </h1>
                ...
                structure when it is weighed. <br />
                ● Volume will be calculated based on the outside shape of the
                container (inside air volume/space will not be subtracted out).{" "}
                <br />
                ...
                dropped. <br />
                ● Once an egg is weighed-in with the structure, that egg cannot
                be exchanged with another. <br />
                ...
                <br />
                20 points if the egg shows no signs of any form of cracking{" "}
                <br />
                ...
                final drop will be from two stories. Only two drops will be
                made. <br />
                ● The egg must be accessible after the first drop to check for
                any cracking. <br />
                ...
                ● The winner will be determined by the container with the
                greatest total score. <br />
                <h1 className="font-primary text-2xl md:text-5xl text-center mt-5 mb-5">
                  Coordinators: <br />
                </h1>
