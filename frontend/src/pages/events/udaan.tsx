          ...
          >
            ...
            >
              ...
              >
                ...
                In this event, teams of 4-6 members will be required to
                construct a RC plane. The plane has to pass under two heights in
                two chances given to them. The plane which will cover the larger
                field will win the game
                <h1 className="font-primary text-2xl md:text-5xl text-center mt-5 mb-5">
                  Guidelines: <br />
                </h1>
