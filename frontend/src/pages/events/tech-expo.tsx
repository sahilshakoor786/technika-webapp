          ...
          >
            ...
            <div className="mb-10">
              <SecondaryButton
                ...
                form_link="https://forms.gle/Hu8x7LgVdFwAAxjv5"
              />
            </div>
            ...
            >
              ...
              and vomit for the sake of grades, out where they belong that is in
              the real world as you make a working prototype to ace this event
              in front of our inter departmental judges panel. The criteria will
              be the level of tech used, exclusiveness, ease of working, the
              output of demo operation and explanation,answers provided by the
              exhibitor to the jury and completed to the conscience of the jury.
              <h1 className="font-primary text-2xl md:text-5xl text-center mt-5 mb-5">
                Guidelines: <br />
              </h1>
